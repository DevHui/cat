...
public class DefaultClientConfigManager implements LogEnabled, ClientConfigManager, Initializable {
    ...
    public void refreshConfig() {
        ...
        try {
            /***
             * 读取远程server中配置的：routers、block、sample、startTransactionTypes、matchTransactionTypes
